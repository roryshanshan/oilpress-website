...
<div class="hero-section">
  <div class="hero-content">
    ...
    <div class="hero-buttons">
      ...
      <a href="/ru/contact/" class="contact-link-button">Запросить цену и расчёт</a>
    </div>
  </div>
...
<div class="contact-section">
  <div class="contact-info">
    <h3>Gavin Lee - Профессиональный директор по продажам к вашим услугам</h3>
    ...
    <a href="/ru/contact/" class="contact-button">Запросить цену и расчёт</a>
  </div>
  <div class="contact-form">
    <form action="https://formspree.io/f/xblaoewy" method="POST">
      ...
      <textarea id="message" name="message" rows="5" placeholder="Сообщение" required></textarea>
