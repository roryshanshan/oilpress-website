...
const VPDocOutlineItem = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["__scopeId", "data-v-2d0bdf9b"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderSlot(_ctx.$slots, "home-hero-info", {}, () => {
        ...
        if (_ctx.name) {
          _push(`<span class="name clip" data-v-1e96e9e8>${_ctx.name ?? ""}</span>`);
        } else {
          _push(`<!---->`);
        }
        if (_ctx.text) {
          _push(`<span class="text" data-v-1e96e9e8>${_ctx.text ?? ""}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</h1>`);
        if (_ctx.tagline) {
          _push(`<p class="tagline" data-v-1e96e9e8>${_ctx.tagline ?? ""}</p>`);
        } else {
          _push(`<!---->`);
        }
      }, _push, _parent);
...
const VPHero = /* @__PURE__ */ _export_sfc(_sfc_main$U, [["__scopeId", "data-v-1e96e9e8"]]);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (typeof _ctx.icon === "object" && _ctx.icon.wrap) {
              ...
              _push2(`<div class="icon" data-v-5219619b${_scopeId}>${_ctx.icon ?? ""}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<h2 class="title" data-v-5219619b${_scopeId}>${_ctx.title ?? ""}</h2>`);
            if (_ctx.details) {
              _push2(`<p class="details" data-v-5219619b${_scopeId}>${_ctx.details ?? ""}</p>`);
            } else {
              _push2(`<!---->`);
            }
            if (_ctx.linkText) {
              _push2(`<div class="link-text" data-v-5219619b${_scopeId}><p class="link-text-value" data-v-5219619b${_scopeId}>${ssrInterpolate(_ctx.linkText)} <span class="vpi-arrow-right link-text-icon" data-v-5219619b${_scopeId}></span></p></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</article>`);
...
const VPFeature = /* @__PURE__ */ _export_sfc(_sfc_main$S, [["__scopeId", "data-v-5219619b"]]);
...
const VPContent = /* @__PURE__ */ _export_sfc(_sfc_main$M, [["__scopeId", "data-v-aff0b8d7"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (!unref(isHome) && (unref(hasLocalNav) || unref(hasSidebar) || unref(y) >= navHeight.value)) {
        ...
        if (unref(hasSidebar)) {
          _push(`<button class="menu"${ssrRenderAttr("aria-expanded", _ctx.open)} aria-controls="VPSidebarNav" data-v-8acdfeb5><span class="vpi-align-left menu-icon" data-v-8acdfeb5></span><span class="menu-text" data-v-8acdfeb5>${ssrInterpolate(unref(theme2).sidebarMenuLabel || "Menu")}</span></button>`);
        } else {
          _push(`<!---->`);
        }
...
const VPLocalNav = /* @__PURE__ */ _export_sfc(_sfc_main$J, [["__scopeId", "data-v-8acdfeb5"]]);
function useNav() {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$_, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span data-v-cd834e02${_scopeId}>${_ctx.item.text ?? ""}</span>`);
          } else {
            return [
              createVNode("span", {
...
const VPMenuLink = /* @__PURE__ */ _export_sfc(_sfc_main$F, [["__scopeId", "data-v-cd834e02"]]);
const _sfc_main$E = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (_ctx.text) {
        _push(`<p class="title" data-v-1963e1bb>${ssrInterpolate(_ctx.text)}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<!--[-->`);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        ...
        ref_key: "el",
        ref: el
      }, _attrs))} data-v-42cb505d><button type="button" class="button" aria-haspopup="true"${ssrRenderAttr("aria-expanded", open.value)}${ssrRenderAttr("aria-label", _ctx.label)} data-v-42cb505d>`);
      if (_ctx.button || _ctx.icon) {
        _push(`<span class="text" data-v-42cb505d>`);
        if (_ctx.icon) {
          _push(`<span class="${ssrRenderClass([_ctx.icon, "option-icon"])}" data-v-42cb505d></span>`);
        } else {
          _push(`<!---->`);
        }
        if (_ctx.button) {
          _push(`<span data-v-42cb505d>${_ctx.button ?? ""}</span>`);
        } else {
          _push(`<!---->`);
        }
...
const VPNavBarTitle = /* @__PURE__ */ _export_sfc(_sfc_main$r, [["__scopeId", "data-v-1e38c6bc"]]);
const _sfc_main$q = /* @__PURE__ */ defineComponent({
...
const VPNavBar = /* @__PURE__ */ _export_sfc(_sfc_main$p, [["__scopeId", "data-v-2a96a3d0"]]);
const _sfc_main$o = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$_, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span data-v-83cc0379${_scopeId}>${_ctx.item.text ?? ""}</span>`);
          } else {
            return [
              createVNode("span", {
                innerHTML: _ctx.item.text
...
const VPNavScreenMenuLink = /* @__PURE__ */ _export_sfc(_sfc_main$n, [["__scopeId", "data-v-83cc0379"]]);
const _sfc_main$m = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$_, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span data-v-aa6008ea${_scopeId}>${_ctx.item.text ?? ""}</span>`);
          } else {
            return [
              createVNode("span", {
                innerHTML: _ctx.item.text
...
const VPNavScreenMenuGroupLink = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["__scopeId", "data-v-aa6008ea"]]);
const _sfc_main$l = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (_ctx.text) {
        _push(`<p class="title" data-v-4b7a798b>${ssrInterpolate(_ctx.text)}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<!--[-->`);
...
const VPNavScreenMenuGroupSection = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["__scopeId", "data-v-4b7a798b"]]);
const _sfc_main$k = /* @__PURE__ */ defineComponent({
...
const VPNavScreenMenuGroup = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["__scopeId", "data-v-956364f9"]]);
const _sfc_main$j = /* @__PURE__ */ defineComponent({
...
const VPNav = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["__scopeId", "data-v-9f75dce3"]]);
const _sfc_main$e = /* @__PURE__ */ defineComponent({
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(sectionTag.value), mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (_ctx.item.text) {
              _push2(`<div class="item"${ssrRenderAttr("role", itemRole.value)}${ssrRenderAttr("tabindex", _ctx.item.items && 0)} data-v-d81de50c${_scopeId}><div class="indicator" data-v-d81de50c${_scopeId}></div>`);
              if (_ctx.item.link) {
...
const VPSidebarItem = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-d81de50c"]]);
const _sfc_main$d = /* @__PURE__ */ defineComponent({
...
const VPSidebarGroup = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["__scopeId", "data-v-8d50c081"]]);
const _sfc_main$c = /* @__PURE__ */ defineComponent({
  __name: "VPSidebar",
  __ssrInlineRender: true,
  props: {
...
const VPSidebar = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-e7c6e512"]]);
const _sfc_main$b = /* @__PURE__ */ defineComponent({
  __name: "VPSkipLink",
  __ssrInlineRender: true,
  setup(__props) {
...
const Layout$1 = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-1df9f90f"]]);
const GridSettings = {
  xmini: [[0, 2]],
  mini: [],
  small: [
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (_ctx.message) {
        _push(`<h2 class="message" data-v-0eeda4b8>${ssrInterpolate(_ctx.message)}</h2>`);
      } else {
        _push(`<!---->`);
      }
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (_ctx.member.desc) {
        _push(`<p class="desc" data-v-962fd8c0>${_ctx.member.desc ?? ""}</p>`);
      } else {
        _push(`<!---->`);
      }
      ...
      if (_ctx.member.sponsor) {
        ...
        _push(ssrRenderComponent(_sfc_main$_, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span class="vpi-heart sp-icon" data-v-962fd8c0${_scopeId}></span> ${ssrInterpolate(_ctx.member.actionText || "Sponsor")}`);
            } else {
              return [
...
const VPTeamMembersItem = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-962fd8c0"]]);
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const { frontmatter, site, page } = useData$1();
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Layout2), null, {
        "nav-bar-content-before": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="mobile-lang-switcher" data-v-826cccfd${_scopeId}><div class="lang-dropdown" data-v-826cccfd${_scopeId}><div class="lang-icon" data-v-826cccfd${_scopeId}><svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" data-v-826cccfd${_scopeId}><path d="M12.87 15.07l-2.54-2.51.03-.03c1.74-1.94 2.98-4.17 3.71-6.53H17V4h-7V2H8v2H1v1.99h11.17C11.5 7.92 10.44 9.75 9 11.35 8.07 10.32 7.3 9.19 6.69 8h-2c.73 1.63 1.73 3.17 2.98 4.56l-5.09 5.02L4 19l5-5 3.11 3.11.76-2.04zM18.5 10h-2L12 22h2l1.12-3h4.75L21 22h2l-4.5-12zm-2.62 7l1.62-4.33L19.12 17h-3.24z" data-v-826cccfd${_scopeId}></path></svg></div><div class="${ssrRenderClass([{ "show": showDropdown.value }, "lang-options"])}" data-v-826cccfd${_scopeId}><div class="${ssrRenderClass([{ "active": currentLang.value === "zh" }, "lang-option"])}" data-v-826cccfd${_scopeId}><span data-v-826cccfd${_scopeId}>中文</span></div><div class="${ssrRenderClass([{ "active": currentLang.value === "en" }, "lang-option"])}" data-v-826cccfd${_scopeId}><span data-v-826cccfd${_scopeId}>English</span></div></div></div></div>`);
          } else {
            return [
              createVNode("div", { class: "mobile-lang-switcher" }, [
                createVNode("div", {
                  class: "lang-dropdown",
                  onClick: toggleDropdown
                }, [
                  createVNode("div", { class: "lang-icon" }, [
                    (openBlock(), createBlock("svg", {
                      ...
                      createVNode("path", { d: "M12.87 15.07l-2.54-2.51.03-.03c1.74-1.94 2.98-4.17 3.71-6.53H17V4h-7V2H8v2H1v1.99h11.17C11.5 7.92 10.44 9.75 9 11.35 8.07 10.32 7.3 9.19 6.69 8h-2c.73 1.63 1.73 3.17 2.98 4.56l-5.09 5.02L4 19l5-5 3.11 3.11.76-2.04zM18.5 10h-2L12 22h2l1.12-3h4.75L21 22h2l-4.5-12zm-2.62 7l1.62-4.33L19.12 17h-3.24z" })
                    ]))
                  ]),
                  createVNode("div", {
                    class: ["lang-options", { "show": showDropdown.value }]
                  }, [
                    createVNode("div", {
                      class: ["lang-option", { "active": currentLang.value === "zh" }],
                      onClick: withModifiers(($event) => switchToLanguage("zh"), ["stop"])
                    }, [
                      createVNode("span", null, "中文")
                    ], 10, ["onClick"]),
                    createVNode("div", {
                      class: ["lang-option", { "active": currentLang.value === "en" }],
                      onClick: withModifiers(($event) => switchToLanguage("en"), ["stop"])
                    }, [
        ...
        "nav-bar-content-after": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="mobile-menu-button" data-v-826cccfd${_scopeId}><div class="menu-icon" data-v-826cccfd${_scopeId}><span data-v-826cccfd${_scopeId}></span><span data-v-826cccfd${_scopeId}></span><span data-v-826cccfd${_scopeId}></span></div></div><div class="social-icons" data-v-826cccfd${_scopeId}><a href="https://wa.me/8619906365856" target="_blank" rel="noopener noreferrer" class="social-icon" style="${ssrRenderStyle({ "color": "#25D366" })}" data-v-826cccfd${_scopeId}><svg width="20" height="20" viewBox="0 0 1024 1024" fill="currentColor" data-v-826cccfd${_scopeId}><path d="M511.872427 0h0.256C794.45376 0 1024.000427 229.674667 1024.000427 512s-229.589333 512-511.872 512c-104.106667 0-200.704-31.018667-281.6-84.565333L33.707093 1002.325333l63.786667-190.250666A508.245333 508.245333 0 0 1 0.000427 512C0.000427 229.674667 229.58976 0 511.872427 0zM
0.739884-14.797688-1.479769-22.196532-1.479769-110.982659 1.479769-198.289017 85.086705-198.289017 188.67052 0 17.017341 2.959538 33.294798 7.398844 49.572255-7.398844 0.739884-15.537572 1.479769-22.936416 1.479768z m346.265896 82.867052l17.757225 59.190752-63.630058-35.514451c-22.936416 5.919075-46.612717 11.83815-70.289017 11.83815-111.722543 0-199.768786-76.947977-199.768786-172.393063-0.739884-94.705202 87.306358-171.653179 198.289017-171.65318 105.803468 0 199.028902 77.687861 199.028902 172.393064 0 53.271676-34.774566 100.624277-81.387283 136.138728z" data-v-826cccfd${_scopeId}></path></svg></a><div class="wechat-qr" data-v-826cccfd${_scopeId}><img src="https://i.postimg.cc/fzV3PSKV/202508260948733.png?dl=1" alt="微信二维码" width="200" height="200" data-v-826cccfd${_scopeId}><p data-v-826cccfd${_scopeId}>扫码添加微信</p></div></div><a href="https://www.linkedin.com/newsletters/hydraulic-oil-pressing-machine-7331966128702836736/" target="_blank" rel="noopener noreferrer" class="social-icon" style="${ssrRenderStyle({ "color": "#0073B1" })}" data-v-826cccfd${_scopeId}><svg width="20" height="20" viewBox="0 0 1024 1024" fill="currentColor" data-v-826cccfd${_scopeId}><path d="M512 1024C229.2224 1024 0 794.7776 0 512 0 229.2224 229.2224 0 512 0c282.7776 0 512 229.2224 512 512 0 282.7776-229.2224 512-512 512z m-137.762133-286.378667V397.380267h-102.4V737.621333h102.4z m-51.2-488.448c-33.024 0-54.5792 22.954667-53.9136 53.589334-0.682667 29.218133 20.8896 52.872533 53.248 52.872533 33.672533 0 55.2448-23.6544 55.2448-52.8896-0.682667-30.6176-21.572267-53.572267-54.5792-53.572267z m133.410133 488.448h102.4V541.405867c0-9.728 1.365333-20.1728 4.061867-26.453334 6.724267-19.456 23.569067-39.645867 51.882666-39.645866 37.034667 0 51.882667 29.917867 51.882667 73.762133V737.621333h102.4V535.842133c0-100.181333-50.517333-146.1248-117.9136-146.1248-54.562133 0-88.251733 32.7168-101.7344 54.272h-2.030933l-4.7104-46.609066h-88.9344c1.348267 29.917867 2.696533 66.0992 2.696533 108.544V737.621333z" data-v-826cccfd${_scopeId}></path></svg></a></div>`);
          } else {
            return [
              createVNode("div", {
                class: "mobile-menu-button",
                onClick: withModifiers(toggleMobileMenu, ["stop"])
              }, [
                createVNode("div", { class: "menu-icon" }, [
                  createVNode("span"),
                  createVNode("span"),
                  createVNode("span")
                ])
              ...
              createVNode("div", { class: "social-icons" }, [
                createVNode("a", {
                  href: "https://wa.me/8619906365856",
                  target: "_blank",
                ...
                createVNode("div", { class: "wechat-container" }, [
                  createVNode("a", {
                    ...
                    (openBlock(), createBlock("svg", {
                      ...
                      createVNode("path", { d: "M337.387283 341.82659c-17.757225 0-35.514451 11.83815-35.514451 29.595375s17.757225 29.595376 35.514451 29.595376 29.595376-11.83815 29.595376-29.595376c0-18.49711-11.83815-29.595376-29.595376-29.595375zM577.849711 513.479769c-11.83815 0-22.936416 12.578035-22.936416 23.6763 0 12.578035 11.83815 23.676301 22.936416 23.676301 17.757225 0 29.595376-11.83815 29.595376-23.676301s-11.83815-23.676301-29.595376-23.6763zM501.641618 401.017341c17.757225 0 29.595376-12.578035 29.595376-29.595376 0-17.757225-11.83815-29.595376-29.595376-29.595375s-35.514451 11.83815-35.51445 29.595375 17.757225 29.595376 35.51445 29.595376zM706.589595 513.479769c-11.83815 0-22.936416 12.578035-22.936416 23.6763 0 12.578035 11.83815 23.676301 22.936416 23.676301 17.757225 0 29.595376-11.83815 29.595376-23.676301s-11.83815-23.676301-29.595376-23.6763z" }),
                      createVNode("path", { d: "M510.520231 2.959538C228.624277 2.959538 0 231.583815 0 513.479769s228.624277 510.520231 510.520231 510.520231 510.520231-228.624277 510.520231-510.520231-228.624277-510.520231-510.520231-510.520231zM413.595376 644.439306c-29.595376 0-53.271676-5.919075-81.387284-12.578034l-81.387283 41.433526 22.936416-71.768786c-58.450867-41.433526-93.965318-95.445087-93.965317-159.815029 0-113.202312 105.803468-201.988439 233.803468-201.98844 114.682081 0 216.046243 71.028902 236.023121 166.473989-7.398844-0.739884-14.797688-1.479769-22.196532-1.479769-110.982659 1.479769-198.289017 85.086705-198.289017 188.67052 0 17.017341 2.959538 33.294798 7.398844 49.572255-7.398844 0.739884-15.537572 1.479769-22.936416 1.479768z m346.265896 82.867052l17.757225 59.190752-63.630058-35.514451c-22.936416 5.919075-46.612717 11.83815-70.289017 11.83815-111.722543 0-199.768786-76.947977-199.768786-172.393063-0.739884-94.705202 87.306358-171.653179 198.289017-171.65318 105.803468 0 199.028902 77.687861 199.028902 172.393064 0 53.271676-34.774566 100.624277-81.387283 136.138728z" })
                    ]))
                  ]),
                  createVNode("div", { class: "wechat-qr" }, [
                    createVNode("img", {
                      src: "https://i.postimg.cc/fzV3PSKV/202508260948733.png?dl=1",
                      alt: "微信二维码",
                      width: "200",
                      height: "200"
                    }),
                    createVNode("p", null, "扫码添加微信")
                  ])
                ]),
                createVNode("a", {
                  href: "https://www.linkedin.com/newsletters/hydraulic-oil-pressing-machine-7331966128702836736/",
                  target: "_blank",
                  rel: "noopener noreferrer",
                  class: "social-icon",
                  style: { "color": "#0073B1" }
                  ...
                  (openBlock(), createBlock("svg", {
                    ...
                    createVNode("path", { d: "M512 1024C229.2224 1024 0 794.7776 0 512 0 229.2224 229.2224 0 512 0c282.7776 0 512 229.2224 512 512 0 282.7776-229.2224 512-512 512z m-137.762133-286.378667V397.380267h-102.4V737.621333h102.4z m-51.2-488.448c-33.024 0-54.5792 22.954667-53.9136 53.589334-0.682667 29.218133 20.8896 52.872533 53.248 52.872533 33.672533 0 55.2448-23.6544 55.2448-52.8896-0.682667-30.6176-21.572267-53.572267-54.5792-53.572267z m133.410133 488.448h102.4V541.405867c0-9.728 1.365333-20.1728 4.061867-26.453334 6.724267-19.456 23.569067-39.645867 51.882666-39.645866 37.034667 0 51.882667 29.917867 51.882667 73.762133V737.621333h102.4V535.842133c0-100.181333-50.517333-146.1248-117.9136-146.1248-54.562133 0-88.251733 32.7168-101.7344 54.272h-2.030933l-4.7104-46.609066h-88.9344c1.348267 29.917867 2.696533 66.0992 2.696533 108.544V737.621333z" })
                  ]))
                ])
              ])
            ];
      ...
      if (showMobileMenu.value) {
        _push(`<div class="custom-mobile-menu" data-v-826cccfd><div class="mobile-nav-content" data-v-826cccfd><div class="mobile-nav-header" data-v-826cccfd><h3 data-v-826cccfd>${ssrInterpolate(currentLang.value === "zh" ? "菜单" : "Menu")}</h3><button class="close-btn" data-v-826cccfd>×</button></div><div class="mobile-nav-menu" data-v-826cccfd><a${ssrRenderAttr("href", currentLang.value === "zh" ? "/zh/" : "/en/")} class="mobile-nav-link" data-v-826cccfd>${ssrInterpolate(currentLang.value === "zh" ? "首页" : "Home")}</a><a${ssrRenderAttr("href", currentLang.value === "zh" ? "/zh/products/" : "/en/products/")} class="mobile-nav-link" data-v-826cccfd>${ssrInterpolate(currentLang.value === "zh" ? "产品系列" : "Products")}</a><div class="mobile-nav-submenu" data-v-826cccfd><div class="${ssrRenderClass([{ "active": activeSubmenu.value === "solutions" }, "mobile-nav-submenu-header"])}" data-v-826cccfd><span data-v-826cccfd>${ssrInterpolate(currentLang.value === "zh" ? "解决方案" : "Solutions")}</span><svg class="${ssrRenderClass([{ "rotated": activeSubmenu.value === "solutions" }, "submenu-arrow"])}" width="12" height="12" viewBox="0 0 12 12" fill="none" data-v-826cccfd><path d="M3 4.5L6 7.5L9 4.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-826cccfd></path></svg></div><div class="mobile-nav-submenu-content" style="${ssrRenderStyle(activeSubmenu.value === "solutions" ? null : { display: "none" })}" data-v-826cccfd><a${ssrRenderAttr("href", currentLang.value === "zh" ? "/zh/solutions/" : "/en/solutions/")} class="mobile-nav-sublink" data-v-826cccfd>${ssrInterpolate(currentLang.value === "zh" ? "方案概览" : "Overview")}</a><div class="mobile-nav-submenu-section" data-v-826cccfd><div class="mobile-nav-submenu-title" data-v-826cccfd>${ssrInterpolate(currentLang.value === "zh" ? "🌾 按油料类型" : "🌾 By Oil Material Type")}</div><a${ssrRenderAttr("href", currentLang.value === "zh" ? "/zh/solutions/seed-oils" : "/en/solutions/seed-oils")} class="mobile-nav-sublink" data-v-826cccfd>${ssrInterpolate(currentLang.value === "zh" ? "粮油类（种子类）" : "Seed Oils")}</a><a${ssrRenderAttr("href", currentLang.value === "zh" ? "/zh/solutions/nuts" : "/en/solutions/nuts")} class="mobile-nav-sublink" data-v-826cccfd>${ssrInterpolate(currentLang.value === "zh" ? "🥜 坚果类" : "🥜 Nut Oils")}</a><a${ssrRenderAttr("href", currentLang.value === "zh" ? "/zh/solutions/fruits" : "/en/solutions/fruits")} class="mobile-nav-sublink" data-v-826cccfd>${ssrInterpolate(currentLang.value === "zh" ? "🥑 果实类" : "🥑 Fruit Oils")}</a><a${ssrRenderAttr("href", currentLang.value === "zh" ? "/zh/solutions/special-oils" : "/en/solutions/special-oils")} class="mobile-nav-sublink" data-v-826cccfd>${ssrInterpolate(currentLang.value === "zh" ? "⚙️ 其他特殊油料" : "⚙️ Special Oils")}</a></div><div class="mobile-nav-submenu-section" data-v-826cccfd><div class="mobile-nav-submenu-title" data-v-826cccfd>${ssrInterpolate(currentLang.value === "zh" ? "🏭 按规模分类" : "🏭 By Scale")}</div><a${ssrRenderAttr("href", currentLang.value === "zh" ? "/zh/solutions/small-workshop" : "/en/solutions/small-workshop")} class="mobile-nav-sublink" data-v-826cccfd>${ssrInterpolate(currentLang.value === "zh" ? "🏠 小型榨油坊方案" : "🏠 Small Workshop")}</a><a${ssrRenderAttr("href", currentLang.value === "zh" ? "/zh/solutions/medium-factory" : "/en/solutions/medium-factory")} class="mobile-nav-sublink" data-v-826cccfd>${ssrInterpolate(currentLang.value === "zh" ? "🏭 中型油厂方案" : "🏭 Medium Factory")}</a><a${ssrRenderAttr("href", currentLang.value === "zh" ? "/zh/solutions/large-industrial" : "/en/solutions/large-industrial")} class="mobile-nav-sublink" data-v-826cccfd>${ssrInterpolate(currentLang.value === "zh" ? "🏢 大型工业化方案" : "🏢 Large Industrial")}</a><a${ssrRenderAttr("href", currentLang.value === "zh" ? "/zh/solutions/special-oil" : "/en/solutions/special-oil")} class="mobile-nav-sublink" data-v-826cccfd>${ssrInterpolate(currentLang.value === "zh" ? "🔬 特种油料加工方案" : "🔬 Special Oil Processing")}</a></div></div></div><a${ssrRenderAttr("href", currentLang.value === "zh" ? "/zh/advantages/" : "/en/advantages/")} class="mobile-nav-link" data-v-826cccfd>${ssrInterpolate(currentLang.value === "zh" ? "公司优势" : "Advantages")}</a><a${ssrRenderAttr("href", currentLang.value === "zh" ? "/zh/news/" : "/en/news/")} class="mobile-nav-link" data-v-826cccfd>${ssrInterpolate(currentLang.value === "zh" ? "新闻资讯" : "News")}</a><a${ssrRenderAttr("href", currentLang.value === "zh" ? "/zh/about/" : "/en/about/")} class="mobile-nav-link" data-v-826cccfd>${ssrInterpolate(currentLang.value === "zh" ? "关于我们" : "About")}</a><a${ssrRenderAttr("href", currentLang.value === "zh" ? "/zh/contact/" : "/en/contact/")} class="mobile-nav-link" data-v-826cccfd>${ssrInterpolate(currentLang.value === "zh" ? "联系我们" : "Contact")}</a></div><div class="mobile-social-icons" data-v-826cccfd><a href="https://wa.me/8619906365856" target="_blank" rel="noopener noreferrer" class="mobile-social-icon" style="${ssrRenderStyle({ "color": "#25D366" })}" data-v-826cccfd><svg width="20" height="20" viewBox="0 0 1024 1024" fill="currentColor" data-v-826cccfd><path d="M511.872427 0h0.256C794.45376 0 1024.000427 229.674667 1024.000427 512s-229.589333 512-511.872 512c-104.106667 0-200.704-31.018667-281.6-84.565333L33.707093 1002.325333l63.786667-190.250666A508.245333 508.245333 0 0 1 0.000427 512C0.000427 229.674667 229.58976 0 511.872427 0zM365.39776 281.429333c-9.770667-23.338667-17.194667-24.234667-32-24.832A285.525333 285.525333 0 0 0 316.50176 256c-19.285333 0-39.424 5.632-51.626667 18.048C250.155093 289.109333 213.33376 324.266667 213.33376 396.501333c0 72.149333 52.778667 141.952 59.861333 151.722667 7.424 9.728 102.912 160 251.093334 221.226667 115.925333 47.914667 150.314667 43.477333 176.725333 37.845333 38.528-8.277333 86.826667-36.693333 98.986667-70.954667 12.16-34.346667 12.16-63.616 8.618666-69.845333-3.584-6.186667-13.354667-9.728-28.16-17.152-14.848-7.381333-86.869333-42.88-100.522666-47.616-13.354667-4.992-26.069333-3.242667-36.138667 10.965333-14.250667 19.797333-28.16 39.936-39.466667 52.053334-8.874667 9.472-23.424 10.666667-35.541333 5.632-16.298667-6.826667-61.952-22.784-118.314667-72.789334-43.562667-38.741333-73.216-86.954667-81.792-101.418666-8.618667-14.805333-0.896-23.381333 5.930667-31.36 7.381333-9.173333 14.506667-15.658667 21.930667-24.234667 7.424-8.576 11.52-13.013333 16.298666-23.082667 5.034667-9.770667 1.493333-19.84-2.090666-27.221333-3.541333-7.381333-33.194667-79.573333-45.354667-108.8z" data-v-826cccfd></path></svg></a><div class="wechat-container" data-v-826cccfd><a href="#" class="mobile-social-icon" style="${ssrRenderStyle({ "color": "#07C160" })}" data-v-826cccfd><svg width="20" height="20" viewBox="0 0 1024 1024" fill="currentColor" data-v-826cccfd><path d="M337.387283 341.82659c-17.757225 0-35.514451 11.83815-35.514451 29.595375s17.757225 29.595376 35.514451 29.595376 29.595376-11.83815 29.595376-29.595376c0-18.49711-11.83815-29.595376-29.595376-29.595375zM577.849711 513.479769c-11.83815 0-22.936416 12.578035-22.936416 23.6763 0 12.578035 11.83815 23.676301 22.936416 23.676301 17.757225 0 29.595376-11.83815 29.595376-23.676301s-11.83815-23.676301-29.595376-23.6763zM501.641618 401.017341c17.757225 0 29.595376-12.578035 29.595376-29.595376 0-17.757225-11.83815-29.595376-29.595376-29.595375s-35.514451 11.83815-35.51445 29.595375 17.757225 29.595376 35.51445 29.