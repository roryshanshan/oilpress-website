...
- **Annual Production**: Global annual production exceeds 80 million tons
...
```mermaid
graph TD
    A[Hazelnut Raw Material] --> B[Cleaning and Impurity Removal]
    B --> C[Crushing and Shelling]
    C --> D[Steaming and Softening]
    D --> E[Oil Pressing]
    E --> F[Filtration and Sedimentation]
    F --> G[Hazelnut Meal Drying]
```

### Modern Process Flow
```mermaid
graph TD
    A[Hazelnut Raw Material] --> B[Intelligent Sorting]
...
- Hazelnut preprocessing equipment
