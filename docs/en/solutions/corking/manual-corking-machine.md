      ...
      children: |
        {
          ...
          "url": "https://hydraulicoilpressing.opchn.com/en/solutions/corking/manual-corking-machine",
          "offers": {
            "@type": "Offer",
      ...
      children: |
        {
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "position": 3,
              "name": "Manual corking machine",
              "item": "https://hydraulicoilpressing.opchn.com/en/solutions/corking/manual-corking-machine"
            }
          ]
        }
---
...
![Manual corking machine](/images/filling-products/manual-corking-machine.webp)

The manual corking machine can be used as a reference for specific models in the corking machine series. This page organizes model positioning, parameter information and supporting suggestions based on public product information to facilitate preliminary selection and page jumps.

## Model positioning

- Series: [Corking Machine Series](/en/solutions/corking/)
- Parameter overview entrance: [Filling and packaging equipment parameter library](/en/products/filling-equipment#cork-manual)
- Applicable scenarios: Suitable as an entry-level configuration for cork-stoppered glass bottles.
...
<table>
  <tbody>
    ...
    <tr>
      <td>Number of plugging heads</td>
      <td>1</td>
      <td>4</td>
      <td>6</td>
    </tr>
    <tr>
      <td>Production capacity (bottles/hour)</td>
      <td>2500</td>
      <td>4500</td>
      <td>6000</td>
    </tr>
    <tr>
      <td>Complete machine power (kw)</td>
      <td>1.5</td>
      <td>3</td>
      <td>3</td>
    </tr>
...
- Look at the parameter overview again: [The location of the manual cork filling machine in the parameter library](/en/products/filling-equipment#cork-manual)
